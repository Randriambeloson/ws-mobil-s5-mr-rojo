	...
	public static Response simuler(String token, String numero, String minute, String seconde) throws Exception {
		...
		try {
			...
			if(response.data != null) {
				...
				int secondeInt = new Integer(seconde).intValue() + ((new Integer(minute).intValue())*60);
				int appelSeconde = secondeInt - reste;
				int appelMinute = appelSeconde/60;
				appelSeconde = appelSeconde%60;
				client.insert_appel(co, client.getNumero() , numero , appelMinute , appelSeconde);
